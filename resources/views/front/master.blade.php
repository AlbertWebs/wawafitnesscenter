...
<html class="no-js" lang="zxx">
   ...
   <head>
      ...
      <meta property="og:image" content="https://wawafitnesscenter.co.ke/uploads/favicon.png">
      ...
      <meta name="twitter:image" content="https://wawafitnesscenter.co.ke/uploads/favicon.png">
                        ...
                        <div class="col-lg-6">
                           <div class="footer-top-btn">
                              <div class="btn-group justify-content-center justify-content-lg-end">
                                 <a href="{{ route('contact') }}" class="th-btn">Contact Us<i class="fa-light fa-arrow-right-long ms-2"></i></a> 
