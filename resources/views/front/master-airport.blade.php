...
<html class="no-js" lang="zxx">
   ...
   <head>
     ...
     <!-- Page Title -->
    <title>Wellness at the Airport – WAWA Fitness Center at JKIA Terminal 1B, Gate 11</title>

    <!-- Meta Description -->
    <meta name="description" content="Recharge at JKIA with WAWA Fitness Center’s wellness lounge at Terminal 1B, Gate 11. Ideal for travelers and airport staff seeking massage and relaxation services.">

    <!-- Meta Keywords -->
    <meta name="keywords" content="airport massage JKIA, wellness lounge JKIA, massage chairs airport Nairobi, WAWA Fitness Center JKIA, relaxation at JKIA, layover massage Nairobi">

    <!-- Robots -->
    <meta name="robots" content="index, follow">

    <!-- Canonical URL -->
    <link rel="canonical" href="{{url('/')}}/wellness-at-the-airport">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{url('/')}}/wellness-at-the-airport">
    <meta property="og:title" content="Wellness at the Airport – WAWA Fitness Center at JKIA Terminal 1B">
    <meta property="og:description" content="WAWA Fitness Center offers wellness services and massage experiences for travelers at JKIA Terminal 1B, Gate 11. Relax and recharge while in transit.">
    <meta property="og:image" content="{{url('/')}}/uploads/airport/20250531_21d4012.jpg">

    <!-- Twitter -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:url" content="{{url('/')}}/wellness-at-the-airport">
    <meta name="twitter:title" content="Wellness at JKIA – WAWA Fitness Center Terminal 1B">
    <meta name="twitter:description" content="Relax during your layover at JKIA with WAWA Fitness Center’s airport wellness lounge. Conveniently located at Terminal 1B, Gate 11.">
    <meta name="twitter:image" content="{{url('/')}}/uploads/airport/20250531_21d4012.jpg">
    ...
    <script type="application/ld+json">
        {
            ...
            "name": "WAWA Fitness Center – Airport Wellness Lounge",
            "image": "{{url('/')}}/uploads/airport/20250531_21d4012.jpg",
            "description": "WAWA Fitness Center provides massage and wellness services at JKIA Terminal 1B, Gate 11 for travelers and staff. Enjoy relaxation during your airport layover.",
            "url": "{{url('/')}}/wellness-at-the-airport",
    ...
    <!--Start of Tawk.to Script-->
      ...
      <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('uploads/favicon.png') }}">
   ...
   <body>
     ...
     <footer class="footer-wrapper bg-title footer-layout1" data-bg-src="{{asset('assets/img/bg/footer_bg_1.png')}}">
                  ...
                  <div class="col-md-6 col-xxl-3 col-xl-4">
                     <div class="widget footer-widget mb-0">
                        <div class="th-widget-about">
                           <div class="about-logo"><a href="{{url('/')}}"><img src="{{asset('uploads/logo.png')}}" alt="Wawa Fitness Center Logo"></a></div>
                           <p class="about-text">Engineered for comfort and effectiveness, the chair delivers a comprehensive neck and back massage using a variety of techniques, including kneading, tapping, pressing, knocking, and Shiatsu.</p>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="widget widget_nav_menu footer-widget">
                        ...
                        <div class="menu-all-pages-container">
                           <ul class="menu">
                              ...
                              <li><a href="{{route('contact')}}">Ticket Support</a></li>
                     ...
                     <div class="row gy-4">
                        <div class="col-lg-6">
                           <div class="title-area mb-0 text-center text-lg-start">
                              <h4 class="sec-title m-0">Explore Our Comprehensive Fitness Solutions</h4>
                           </div>
                        </div>
                        <div class="col-lg-6">
         ...
         <div class="heart-rate2" data-bg-src="{{asset('theme/assets/img/shape/preloader3.svg')}}"></div>
         <div class="heart-rate" data-bg-src="{{asset('theme/assets/img/shape/preloader2.svg')}}">
            <div class="fade-in"></div>
            <div class="fade-out"></div>
         </div>
      </footer>
