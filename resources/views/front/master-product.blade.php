...
<html class="no-js" lang="zxx">
   ...
   <head>
    ...
    <meta name="viewport" content="width=device-width,initial-scale=1,shrink-to-fit=no">
        ...
        <title>{{$Chair->name}} in JKIA - Massage Chairs For Hire - WAWA Fitness Center </title>
        <meta name="description" content="{{$Chair->meta}}">
        ...
        <meta name="robots" content="index, follow">
        <link rel="canonical" href="{{url('/')}}/massage-chairs/{{$Chair->slug}}">

        <!-- Open Graph / Facebook -->
        <meta property="og:type" content="website">
        <meta property="og:url" content="{{url('/')}}/massage-chairs/{{$Chair->slug}}">
        <meta property="og:title" content="{{$Chair->name}} in JKIA - Massage Chairs For Hire - WAWA Fitness Center ">
        <meta property="og:description" content="{{$Chair->meta}}">
        <meta property="og:image" content="{{url('/')}}/uploads/category/{{$Chair->slung}}">

        <!-- Twitter -->
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:url" content="{{url('/')}}/massage-chairs/{{$Chair->slug}}">
        <meta name="twitter:title" content="{{$Chair->name}} in JKIA - Massage Chairs For Hire - WAWA Fitness Center ">
        <meta name="twitter:description" content="{{$Chair->meta}}">
