!(function (e) {
    ...
    e("[data-bg-src]").length > 0 &&
        ...
        e(".hero-thumb").length && e(".hero-thumb").activateSliderThumbs({ sliderTab: !0, tabButton: ".tab-btn" }),
        ...
        (e.fn.shapeMockup2 = function () {
            e(this).each(function () {
                var t = e(this),
                    ...
                    s = t.data("bottom"),
                    o = t.data("left");
                t.css({ top: a, right: n, bottom: s, left: o }).removeAttr("data-top").removeAttr("data-right").removeAttr("data-bottom").removeAttr("data-left").parent().addClass("shape-mockup-wrap2");
            });
        }),
    ...
    if (v.length > 0) {
        const t = e(".image-container"),
            a = new PANOLENS.Viewer({ container: t.get(0), autoRotate: !0, autoRotateSpeed: 0.5, controlBar: !1 });
        v.each(function () {
    ...
    var b = document.getElementById("filt-monthly"),
        y = document.getElementById("filt-yearly"),
        C = document.getElementById("switcher"),
        w = document.getElementById("monthly"),
        k = document.getElementById("yearly");
    e(".pricing-tabs").length &&
        (b.addEventListener("click", function () {
            (C.checked = !1), b.classList.add("toggler--is-active"), y.classList.remove("toggler--is-active"), w.classList.remove("hide"), k.classList.add("hide");
        }),
        y.addEventListener("click", function () {
            (C.checked = !0), y.classList.add("toggler--is-active"), b.classList.remove("toggler--is-active"), w.classList.add("hide"), k.classList.remove("hide");
        }),
        C.addEventListener("click", function () {
            y.classList.toggle("toggler--is-active"), b.classList.toggle("toggler--is-active"), w.classList.toggle("hide"), k.classList.toggle("hide");
        }));
    ...
    if ((new WOW().init(), e(".reveal").length)) {
        gsap.registerPlugin(ScrollTrigger),
            document.querySelectorAll(".reveal").forEach((e) => {
                ...
                a.set(e, { autoAlpha: 1 }), a.from(e, 1, { xPercent: -100, ease: Power2.out }), a.from(t, 1, { xPercent: 100, scale: 1, delay: -1, ease: Power2.out });
            });
    }
    if (e(".text-anime-style-1").length) {
        ...
        document.querySelectorAll(".text-anime-style-1").forEach((a) => {
            let n = new SplitText(a, { type: "chars, words" });
            gsap.from(n.words, { duration: 1, delay: t, x: 20, autoAlpha: 0, stagger: e, scrollTrigger: { trigger: a, start: "top 85%" } });
        });
    }
    if (e(".text-anime-style-2").length) {
        ...
        document.querySelectorAll(".text-anime-style-2").forEach((s) => {
            ...
            gsap.from(o.chars, { duration: 2, delay: a, x: t, autoAlpha: 0, stagger: e, ease: n, scrollTrigger: { trigger: s, start: "top 85%" } });
        });
    }
...
swiper.on('slideChangeTransitionEnd', function () {
    // Reset zoom for the new active slide
    resetZoom();
});
    ...
    if (imageContainer) {
        ...
        imageContainer.addEventListener('mousemove', (e) => {
            if (imageContainer.classList.contains('zoomed')) {
                ...
                const offsetX = (x / rect.width) * (scale - 1) * img.offsetWidth;
                const offsetY = (y / rect.height) * (scale - 1) * img.offsetHeight;
                img.style.transform = `scale(<span class="math-inline">\{scale\}\) translate\(</span>{-offsetX}px, ${-offsetY}px)`;
            }
        });
...
function resetZoom() {
    document.querySelectorAll('.image-container.zoomed').forEach(container => {
